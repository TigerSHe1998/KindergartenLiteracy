...
//        case "begin":
//            if beginningSoundsSaveFile![currentButton.currentTitle!] as! Int >= 6 {
//                setBeginningSoundsCompositePuzzle(currentButton: currentButton)
//            }
        case "end":
...
//        case "begin":
//            if beginningSoundsSaveFile![sender.currentTitle!] as! Int >= 6 {
//                let vc = mainStoryBoard.instantiateViewController(identifier: "rhyme_vc") as! RhymeViewController
//                vc.passedInLetter = sender.currentTitle

//
//  BeginningSoundsTwoButtonViewController.swift
...
class BeginningSoundsTwoButtonViewController: UIViewController {
    ...
    @IBAction func twoButtonLevel(_ sender: Any) {
        ...
        vc.desiredLabelTwo = (sender as! UIButton).titleLabel!.text!
